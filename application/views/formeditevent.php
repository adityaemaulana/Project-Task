...
<body>
	...
	<div class="row justify-content-center mt-5">
		<?php echo form_open_multipart('EditEvent_C/editEvent', 'class="col-7" runat="server"'); ?>
			<h1 class="text-center mt-5">Ubah Informasi Event Anda</h1>
			...
			<div style="background-color: white" class="px-5 py-4 mt-5 rounded">
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" id="inputTitle" name="title" value="<?php echo  $item->title; ?>">
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" id="inputSubtitle" name="subtitle" value="<?php echo $item->subtitle; ?>">
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" id="inputTarget" name="target" value="<?php echo $item->target ?>">
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" id="datepicker" name="deadline" value="<?php echo $item->hari ?>">
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<textarea class="form-control" id="inputCaption" rows="3" name="caption"><?php echo $item->content ?></textarea>
			...
			<div style="background-color: white" class="px-5 py-4 mt-5 rounded">
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" id="inputTanggal" name="tanggal" value="<?php echo $item->date ?>">
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" id="inputWaktu" name="waktu" value="<?php echo $item->time ?>">
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" id="inputLokasi" name="lokasi" value="<?php echo $item->location ?>">
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<textarea class="form-control" id="inputAbout" rows="3" name="about"><?php echo $item->about ?></textarea>
			...
			<div><input class="btn btn-lg btn-success mt-3 ml-2" type="submit" value="Update Event"></div>
		</form>
	</div>
